...
public class Vivecraft_v1_21_R4 implements VivecraftCompatibility {
    ...
    public Vivecraft_v1_21_R4() {
        classEndermanFreezeWhenLookedAt = ReflectionUtil.getMinecraftClass("world.entity.monster", "EntityEnderman$a"); // https://mappings.dev/1.21.5/net/minecraft/world/entity/monster/EnderMan$EndermanFreezeWhenLookedAt.html
        ...
        eyeHeightAccessor = ReflectionUtil.getField(Entity.class, "bf");  // https://mappings.dev/1.21.5/net/minecraft/world/entity/Entity.html
        resetFallDistanceMethod = ReflectionUtil.getMethod(Entity.class, "j");
    }
            ...
            for (DoubleSupplier doublesupplier : entityYChecks) {
                ...
                if (d2 > (double) 1.0F - d0 / (flag ? d1 : (double) 1.0F)) {
                    if (isVr) {
                        ...
                        return entity.hasLineOfSight(enderman, visualShape ? ClipContext.Block.VISUAL : ClipContext.Block.COLLIDER, net.minecraft.world.level.ClipContext.Fluid.NONE, doublesupplier.getAsDouble());
                    }
                }
            }
