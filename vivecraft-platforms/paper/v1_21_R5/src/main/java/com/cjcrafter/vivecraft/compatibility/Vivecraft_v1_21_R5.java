...
public class Vivecraft_v1_21_R5 implements VivecraftCompatibility {
    ...
    public Vivecraft_v1_21_R5() {
        classEndermanFreezeWhenLookedAt = ReflectionUtil.getMinecraftClass("world.entity.monster", "EntityEnderman$a"); // https://mappings.dev/1.21.6/net/minecraft/world/entity/monster/EnderMan$EndermanFreezeWhenLookedAt.html
        ...
        eyeHeightAccessor = ReflectionUtil.getField(Entity.class, "bz");  // https://mappings.dev/1.21.6/net/minecraft/world/entity/Entity.html
