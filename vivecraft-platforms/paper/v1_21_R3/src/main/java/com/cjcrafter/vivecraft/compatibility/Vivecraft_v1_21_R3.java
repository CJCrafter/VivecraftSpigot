...
public class Vivecraft_v1_21_R3 implements VivecraftCompatibility {
    ...
    public Vivecraft_v1_21_R3() {
        classEndermanFreezeWhenLookedAt = ReflectionUtil.getMinecraftClass("world.entity.monster", "EntityEnderman$a"); // https://mappings.dev/1.21.4/net/minecraft/world/entity/monster/EnderMan$EndermanFreezeWhenLookedAt.html
        ...
        eyeHeightAccessor = ReflectionUtil.getField(Entity.class, "bc");  // https://mappings.dev/1.21.4/net/minecraft/world/entity/Entity.html
