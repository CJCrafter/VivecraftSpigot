...
import com.cjcrafter.vivecraft.utils.MetadataHelper;
        ...
        switch (disc) {
            ...
            case VERSION:
                ...
                try {
                    ...
                    if (vse.getConfig().getBoolean("settingOverrides.thirdPersonItemsCustom")) {
                        final ByteArrayOutputStream baos = new ByteArrayOutputStream();

                        baos.write(PacketDiscriminators.SETTING_OVERRIDE.ordinal());

                        writeSetting(baos, "thirdPersonItemsCustom", true);
